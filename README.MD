...
- Window tiling manager configurations of Aerospace (macOS) and Sway (Wayland / Ubuntu)
- Sway extension configurations: waybar, wofi, mako etc.
- tmux configuration
- tmux-sessionizer
...
- Install bat and eza with your package manager.
